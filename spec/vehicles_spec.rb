...
describe('Vehicle') do
  ...
  describe("#make") do
    it("returns the make of the vehicle") do
      test_vehicle = Vehicle.new("Citroen", "Limon", 1995)
      expect(test_vehicle.make()).to(eq("Citroen"))
    end
  end
  ...
  describe("#model") do
    it("returns the model of the vehicle") do
      test_vehicle = Vehicle.new("Citroen", "Limon", 1995)
      expect(test_vehicle.model()).to(eq("Limon"))
    end
  end
  ...
  describe("clear") do
    it("empties out all of the saved vehicles") do
      Vehicle.new("Citroen", "Limon", 1995)
      Vehicle.clear()
      expect(Vehicle.all()).to(eq([]))
    end
  end
  describe("#age") do
    it("returns the vehicles age") do
      test_vehicle = Vehicle.new("Citroen", "Limon", 1995)
      expect(test_vehicle.age()).to(eq(22))
    end
  end
